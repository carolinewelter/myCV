...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {Certificate in University Teaching;}{Aug 2023 \textbf{--} Aug 2025 (Expected)}
      %{\textbf{GPA: 3.89/4.00}}
      {}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Graduate Research Assistant (Ph.D.)}{Aug 2021 \textbf{--} Currently}
        \resumeItemListStart
            \resumeItem{Currently working with Dr. Heather M. Stephens at the \href{https://rri.wvu.edu/home}{Regional Research Institute}.} 
        \resumeItemListEnd
...
\section{Professional Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {{Foundation of Science and Technology}}{Campo Grande, MS, Brazil}
...
%   \resumeSubHeadingListStart
%    \small{\item{
%        \textbf{Daniel Grossman, Ph.D.}{, Associate Professor of Economics at the West Virginia University.}
%        { \href{mailto:Daniel.Grossman@mail.wvu.edu}{\color{blue}Daniel.Grossman@mail.wvu.edu}} \\ \vspace{3pt}
%        \textbf{Jane Ruseski, Ph.D.}{, Professor and Graduate Coordinator of Economics at the West Virginia University.}
%        { \href{mailto:Jane.Ruseski@mail.wvu.edu}{\color{blue}Jane.Ruseski@mail.wvu.edu}} \\ \vspace{3pt}
%        \textbf{Heather Stephens, Ph.D.}%{,Director, Regional Research Institute (RRI) and Associate Professor of Resource Economics and Management at the West Virginia University.}
%        { \href{mailto:heather.stephens@mail.wvu.edu}{\color{blue}heather.stephens@mail.wvu.edu}} \\ \vspace{3pt}
%        \textbf{Randall Jackson, Ph.D.}%{, Professor Emeritus and former director of the Regional Research Institute (RRI) at the West Virginia University.}
%        { \href{mailto:randall.jackson@mail.wvu.edu}{\color{blue}randall.jackson@mail.wvu.edu}} \\ \vspace{3pt}  
